...
WEB_APT_DEPS="wget curl w3m w3m-img gpg gpg-agent openssl"
...
USER_APT_DEPS="python-pip xclip less file diffutils jq inotify-tools fdupes file-roller bzip2 lzma gh entr exiftool pwgen ssh-askpass postgresql-client-common rng-tools"
...
NET_APT_DEPS="stunnel4 openssh-server openssh-client netcat socat mtr dnsutils net-tools tcpflow tcpdump inetutils-ping inetutils-traceroute nmap whois rsync nfs-common gping"
FILE_UTILITIES="lsof ncdu silversearcher-ag gist libfuse2"
